...
function setup() {
  ...
  // bottom layer 
  box1 = new Box(602,265,45,55,"yellow");
  box2 = new Box(600+box1.width+4,265,45,55,"yellow");
  box3 = new Box(box2.body.position.x+box2.width+2.5,265,45,55,"yellow");
  box4 = new Box(box3.body.position.x+box3.width+2.5,265,45,55,"yellow");
  box5 = new Box(box4.body.position.x+box3.width+2,265,45,55,"yellow");
 
  // middle layer
  box6 = new Box(box2.body.position.x,208,45,55,"yellow");
  box7 = new Box(box6.body.position.x+box6.width+3,208,45,55,"yellow");
  box8 = new Box(box7.body.position.x+box7.width+3,208,45,55,"yellow");

  // upper layer
  box9 = new Box(box3.body.position.x+1,206-box5.height,45,55,"yellow");
